...
const { format, addBusinessDays, subDays, subMonths, startOfMonth, endOfMonth } = require('date-fns');
...
// get toggl since/until object for the last calendar month
const lastMonth = () => {
...
/**
 * From an array of TogglEntry, merge duplicates by
 * checking issueKey/description, summing the hours.
 * All other properties will be pulled from the first instance.
